...
func main() {
	...
	*/
	...
	Logger.Printf("Hello %v, connecting to the hydra chat system.... \n", name)
	...
	Logger.Println("Connected to hydra chat system")
	name += ":"
	defer conn.Close()
	go func() {
