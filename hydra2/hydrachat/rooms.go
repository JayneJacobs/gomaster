...
func (r *room) AddClient(c net.Conn) {
	var Logger = hlogger.GetInstance("roomAddClient")
...
func (r *room) RemoveClient(wc chan<- string) {
	var Logger = hlogger.GetInstance("roomsRemovingclient")
...
func (r *room) Run() {
	var Logger = hlogger.GetInstance("roomRun")
...
func (r *room) broadcastMsg(msg string) {
	var Logger = hlogger.GetInstance("broadcastclient")
